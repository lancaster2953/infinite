...
{ artist: "ONEWE", name: "Meteor Shower (한여름 밤 유성우)", youtubeId: "jvg8oMAAZmc" },
{ artist: "ONEWE", name: "AuRoRa", youtubeId: "2kVJYat96Bw" },
{ artist: "ONEWE", name: "Alice", youtubeId: "dyjuKLX7LY4" },
{ artist: "ONEWE", name: "A book in Memory (기억 속 한 권의 책)", youtubeId: "TdaNbo8lm58" },
{ artist: "ONEWE", name: "COSMOS (천체)", youtubeId: "ulUOGpwWWsg" },
{ artist: "ONEWE", name: "LOGO", youtubeId: "Pv9VZ-fSaIg" },
{ artist: "ONEWE", name: "Montage_ (꿈속에서 놓친 너, 옅은 잠결에 흐르길)", youtubeId: "7ZEV7Rxl67g" },
{ artist: "ONEWE", name: "If", youtubeId: "cSVFOddPick" },
{ artist: "ONEWE", name: "Shoot It Out", youtubeId: "f4m3FNAiU90" },
{ artist: "ONEWE", name: "TRAUMA (Aquarium)", youtubeId: "S6kTMgPP3vs" },
]
      function Vt(e, t) {
        (null == t || t > e.length) && (t = e.length);
        for (var n = 0, r = new Array(t); n < t; n++) r[n] = e[n];
